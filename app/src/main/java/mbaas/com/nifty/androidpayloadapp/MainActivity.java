...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //**************** APIキーの設定とSDKの初期化 **********************
        NCMB.initialize(this, "f061e52bd5341174ffea6d8c7e1141ce22a5d6c4fa820c254429fb2e19c31412", "412fbbbd67f14f314f5966704c8ad17d4d6997bb769fdb31ef93d72479b26e4d");
        final NCMBInstallation installation = NCMBInstallation.getCurrentInstallation();

        //GCMからRegistrationIdを取得しinstallationに設定する
        installation.getRegistrationIdInBackground("397351349548", new DoneCallback() {
            @Override
    ...
    public void onResume() {
        ...
        _pushId = (TextView) findViewById(R.id.txtPushid);
        String pushid = intent.getStringExtra("message");
